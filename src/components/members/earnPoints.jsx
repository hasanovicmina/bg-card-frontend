...
class EarnPoints extends Component {
      ...
      <div className="card" key={i._id}>
        <div className="card-body">
          ...
          <a
            ...
            onClick={() =>
              this.props.onClick(p.partnerID, p._id, i._id, i.pointsToEarn)
            }
          >
            Buy and earn {i.pointsToEarn} points!
          </a>
        </div>
      </div>
    );
  ...
  render() {
    ...
    return (
      <div>
        <h3>Earn points through purchase</h3>
        <div className="form-group m-3 p-3">
          <label>Choose the place where you want to earn points</label>
